<?php
add_action('add_meta_boxes', 'veuse_slider_add_custom_box');
add_action('save_post', 'veuse_slider_save_postdata');

/* Adds a box to the main column on the Post and Page edit screens */
function veuse_slider_add_custom_box() {
    add_meta_box( 'veuse_slider_sectionid', __( 'Slideshow Builder', 'veuse' ),'veuse_slider_custom_box', 'veuse_slider', 'normal', 'high' );
   }


/* Prints the box content */
function veuse_slider_custom_box() {
 	global $post,  $term;
...
function veuse_slider_save_postdata( $post_id ) {
